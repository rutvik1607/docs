                ...
                <div className="sent-modal-content">
                    <div className="sent-modal-icon-box">
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="30" y="20" width="60" height="80" rx="5" fill="#BBDEFB" stroke="#42A5F5" stroke-width="2"/>
                          ...
                          <path d="M50 75 L60 85 L80 65" stroke="#4CAF50" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>

                          <path d="M20 90 Q30 80 40 90 L40 100 H20 Z" fill="#E3F2FD" stroke="#90CAF9" stroke-width="1"/>
                          <path d="M80 90 Q90 80 100 90 L100 100 H80 Z" fill="#E3F2FD" stroke="#90CAF9" stroke-width="1"/>
                          <path d="M15 95 Q25 85 35 95 L35 105 H15 Z" fill="#E3F2FD" stroke="#90CAF9" stroke-width="1"/>
                          <path d="M85 95 Q95 85 105 95 L105 105 H85 Z" fill="#E3F2FD" stroke="#90CAF9" stroke-width="1"/>
